...
import { currentAddGroupIdx, groupList, isModalVisible } from "../atoms";
import Rate from "./Rate";
import { FormEvent, useState } from "react";

const GroupWorkListAdder = () => {
  ...
  const addWorkList = (e: FormEvent<HTMLFormElement>) => {
    ...
    const newGroupList = nGroupList.map((workList, idx) =>
      idx === currentGroupIdx
        ? [...workList, { deadline: new Date(deadline), title, content, rate }]
        : workList
    );
...
export default GroupWorkListAdder;
